...
-(void) setupInit
{
    ...
    CGFloat itemWidth = 53.0f;
    CGFloat itemHeight = 53.0f;
    CGFloat spacing = 18.0f;
    if(self.digitsCount == 6)
    {
        itemWidth = itemHeight = 53.0f;
        spacing = 7.0f;
    }
    ...
    for (NSInteger i = 0; i < self.digitsCount; i++)
    {
        ...
        {
            [self setView:label cornerWithRadius:12.0f borderWidth:0.0f borderColor:self.disabledBorderColor];
        }
